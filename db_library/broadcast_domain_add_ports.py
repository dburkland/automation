...
DOCUMENTATTION = '''
---
module: broadcast_domain_add_ports
version_added: "1.0"
author: "Dan Burkland (@dburkland)"
short_description: Create broadcast domain
description:
  - Ansible module to add ports to a broadcast domains on NetApp CDOT arrays via the NetApp python SDK.
requirements:
...
def broadcast_domain_add_ports(module):
    ...
    api = NaElement("net-port-broadcast-domain-add-ports")
...
def main():
    ...
    results = broadcast_domain_add_ports(module)
