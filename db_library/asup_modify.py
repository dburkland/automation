...
options:
  ...
  note_to:
    required: False
    description:
      - "You can specify up to 5 note-to addresses"
  partner:
    required: False
    description:
...
def asup_modify(module):
    ...
    if module.params['note_to']:
        xi4 = NaElement("noteto")
        api.child_add(xi4)
        for addr in partner:
            xi4.child_add_string("mail-address", addr)
...
def main():
    ...
    argument_spec.update(dict(
        ...
        note_to=dict(required=False, type='list'),
