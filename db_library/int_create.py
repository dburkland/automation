...
options:
  ...
  auto_revert:
    required: False
    description:
      - "Specifies whether the auto-revert setting is enabled on the LIF at the time of creation"
'''
...
def int_create(module):
    ...
    auto_revert = module.params['auto_revert']
    ...
    if module.params['auto_revert']:
      api.child_add_string('is-auto-revert', auto_revert)
...
def main():
    ...
    argument_spec.update(dict(
        ...
        auto_revert=dict(required=False, type='bool'),))
